...
Figure 1: Levels of sunshine across Europe `r Citep(myBib, "quierosolSolarPanelsInstallation")`
</p>
```{r, echo=FALSE, out.width='80%', fig.align='center'}
# Add picture
...
PrintBibliography(refs, .opts = list(style = "html"))
```
---