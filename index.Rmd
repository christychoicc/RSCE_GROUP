...
# Barcelona
- Barcelona is a strong case for urban photovoltaic deployment because it combines high solar potential with strong climate policy ambition.
- The city estimates 7,899,532 m² of roof area available for energy capture.
- Rooftop PV generation potential is estimated at 1,191 GWh/year, roughly 60% of domestic electricity consumption.
- Flat and slightly inclined terraces account for 67% of roof surface area, creating major rooftop opportunity.
- Yet Barcelona still produces just over 1% of the energy it consumes on its territory from renewables.
.pull-left[
...
- PV is particularly suitable for cities because it can be installed on existing roofs, façades, pergolas, and public infrastructure.
...
Barcelona has major rooftop solar potential, but deployment remains below what is technically possible and socially desirable.

1. Low local renewable self-sufficiency
   - Just over 1% of the energy consumed in Barcelona is produced locally from renewables
   - Only 5% of inhabitants had solar energy in their homes in 2022

2. Underused rooftop resource
   - 7,899,532 m² available roof area for energy capture
   - 1,191 GWh/year rooftop PV potential
   - 67% of roofs are flat or slightly inclined terraces

3. Social and urban constraints
   - Ageing housing stock and energy-poverty risks increase the need for targeted intervention
   - Current deployment is not yet sufficiently aligned with social need

4. Governance gap
   - Existing installations are concentrated in municipal buildings and infrastructure
   - Barcelona needs a city-scale operational method to prioritise rooftop solar and storage for maximum public benefit

---
# Policy Goals and Agenda
.panelset[
.panel[.panel-name[Local Policy 1]
...
```
<p style="font-size: 0.6em; text-align: center; margin-top: 0;">
Figure 4: Barcelona Climate Action Plan, Line of Action 5 (Source: <a href="https://www.barcelona.cat/barcelona-pel-clima/sites/default/files/climate_plan_maig.pdf">Ajuntament de Barcelona(2018)</a>)
</p>
]
.pull-middle-3[
```{r, echo=FALSE, out.width='100%', fig.align='right'}
...
```
<p style="font-size: 0.6em; text-align: center; margin-top: 0;">
Figure 5: Barcelona Climate Action Plan, Line of Action 9 (Source: <a href="https://www.barcelona.cat/barcelona-pel-clima/sites/default/files/climate_plan_maig.pdf">Ajuntament de Barcelona(2018)</a>)
</p>
]
.pull-right-3[
```{r, echo=FALSE, out.width='100%', fig.align='right'}
...
```
<p style="font-size: 0.6em; text-align: center; margin-top: 0;">
Figure 6: Barcelona Climate Action Plan, Line of Action 12 (Source: <a href="https://www.barcelona.cat/barcelona-pel-clima/sites/default/files/climate_plan_maig.pdf">Ajuntament de Barcelona(2018)</a>)
</p>
]
]

.panel[.panel-name[Local Policy 2]
- The city offers tax incentives for solar installations
- Barcelona aims to triple municipal PV capacity by 2027 and achieve a fivefold increase by 2030
]


.panel[.panel-name[National Policy]
- Spain’s updated PNIEC/NECP targets 81% renewable electricity generation by 2030
- Expanding urban rooftop PV supports national decarbonisation and electrification goals

]

.panel[.panel-name[EU]
- The SET Plan treats PV as a strategic technology for the energy transition
- EU policy emphasises rapid deployment and stronger PV system capacity
]
...
```
<p style="font-size: 0.6em; text-align: center; margin-top: 0;">
Figure 7: SDG 7 (Source: <a href="https://www.un.org/sustainabledevelopment/news/communications-material/">United Nations(2024)</a>)
</p>
]
.pull-middle-3[
```{r, echo=FALSE, out.width='100%', fig.align='right'}
...
```
<p style="font-size: 0.6em; text-align: center; margin-top: 0;">
Figure 8: SDG 11 (Source: <a href="https://www.un.org/sustainabledevelopment/news/communications-material/">United Nations(2024)</a>)
</p>
]
.pull-right-3[
```{r, echo=FALSE, out.width='100%', fig.align='right'}
...
```
<p style="font-size: 0.6em; text-align: center; margin-top: 0;">
Figure 9: SDG 13 (Source: <a href="https://www.un.org/sustainabledevelopment/news/communications-material/">United Nations(2024)</a>)
</p>
]
