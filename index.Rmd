...
Barcelona 2030 Agenda localises SDGs into city scale targets and indicators as a municipal framework, policy objectives were implemented within the Barcelona Climate Plan through lines of action on rooftops, renewable energy, and green transition. 
.pull-left-3[
```{r, echo=FALSE, out.width='100%', fig.align='right'}
# Add picture
